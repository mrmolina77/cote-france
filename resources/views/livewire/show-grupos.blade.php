    ...
    <div class="mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <table class="items-center bg-transparent w-full border-collapse">
                ...
                <tr>
                    ...
                    <td class="flex border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                        ...
                        @if ($item->estado_id == 2)
                            <i class="fas fa-check text-blue-500 mr-4 cursor-pointer" wire:click="activate({{ $item->grupo_id }})"></i>
                        @else
        ...
        <x-dialog-modal wire:model="open_edit">
            ...
            <x-slot name="content">
                ...
                <div @if(data_get($grupo,'es_evento')) class="hidden" @endif>
                    <div class="mb-4 flex">
                        <x-forms.label value="{{__('Level')}}: " />
                        <x-select class="flex-1 ml-4" wire:model="grupo.nivel_id">
