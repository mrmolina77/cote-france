<div>
    ...
    <x-dialog-modal maxWidth="3xl" wire:model="open">
        ...
        <x-slot name="content">
            ...
            <div @if($es_evento) style="display:none;" @endif>
                <div class="mb-4 flex">
            ...
            <div>
                <div class="mb-4 flex">
                    ...
                    <x-forms.input type="date" class="flex-1 ml-4" wire:model="fecha_inicio"/>
                </div>
                <x-forms.input-error for="fecha_inicio"/>
            </div>
            <div>
                <div class="mb-4 flex">
                    ...
                    <tbody>
                        @forelse ($detalles_grupos as $key => $item )
                            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <i class="fas fa-trash text-red-500 mr-4 cursor-pointer" wire:click="$emit('showDeleteDetalle',{{$key}})"></i>
                                </td>
                            </tr>
                        @empty
                            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
