    ...
    <x-dialog-modal wire:model="open_edit_diario">
        ...
        <x-slot name="content">
            ...
            <div class="mt-2 flex justify-end">
                <label class="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-slate-600">
                    <x-checkbox wire:model="validadoEstudiantesSeccion" class="rounded text-indigo-600 focus:ring-indigo-500 h-4 w-4" />
                    Validar sección estudiantes
                </label>
            </div>
            ...
            <div class="mt-6 border border-slate-100 rounded-xl overflow-hidden">
                <div class="bg-slate-50 px-4 py-2 border-b border-slate-200/60 flex items-center justify-between gap-3">
                    <h3 class="text-xs uppercase tracking-wider font-bold text-slate-500">Clases de prueba</h3>
                    <label class="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-slate-600">
                        <x-checkbox wire:model="validadoPruebaSeccion" class="rounded text-indigo-600 focus:ring-indigo-500 h-4 w-4" />
                        Validar sección
                    </label>
                </div>
                <div class="relative overflow-x-auto">
