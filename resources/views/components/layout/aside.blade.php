<aside class="relative bg-sidebar h-screen w-64 hidden sm:block shadow-xl">
    ...
    <nav class="text-white text-base font-semibold pt-3">
        ...
        <x-layout.aside-link href="{{ route('horario_profesor',['modalidad' => 1]) }}" :active="request()->routeIs('horario_profesor')" :modalidad="1">
            <i class="fas fa-sticky-note mr-3"></i>
            {{ __('Timetable in person') }}
        </x-layout.aside-link>
        @endif
        @if(auth()->user()->role->roles_codigo == 'profe' )
        <x-layout.aside-link href="{{ route('horario_profesor',['modalidad' => 2]) }}" :active="request()->routeIs('horario_profesor')" :modalidad="2">
            <i class="fas fa-sticky-note mr-3"></i>
            {{ __('Timetable online') }}
        </x-layout.aside-link>
        @endif
