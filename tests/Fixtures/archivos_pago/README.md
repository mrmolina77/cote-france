...
* `comprobante.pdf` se generó de forma determinista con catálogo, árbol de páginas,
...
* `comprobante.png.base64` y `comprobante.jpeg.base64` representan imágenes RGB de
  ...
  el transporte del cambio no dependan de soporte para parches binarios. El helper las
  decodifica de forma estricta a archivos temporales reales antes de cada prueba; la
